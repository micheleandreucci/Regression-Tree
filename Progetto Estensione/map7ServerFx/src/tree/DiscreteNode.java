...
/**
 * modella l'entita nodo di split relativo ad un attributo indipendente discreto
 */
public class DiscreteNode extends SplitNode implements Serializable {
	 ...
	 */
	@Override
	void setSplitInfo(final Data trainingSet, final int beginExampleIndex, final int endExampleIndex,
